...
public:
	...
	unsigned int BackgroundCreateCompressedTexture(unsigned char* buffer, uint32_t dataSize, uint32_t totalSize, int w, int h, int texunit, int numMips, TexFormat format, const char* name, bool forceNoMips = false, bool allowQualityReduction = false);
	unsigned int CreateCompressedTexture(unsigned char* buffer, uint32_t dataSize, uint32_t totalSize, int w, int h, int texunit, int numMips, TexFormat format, const char* name, bool forceNoMips = false, bool allowQualityReduction = false);
